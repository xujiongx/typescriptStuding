 ...
 * @LastEditTime: 2020-08-26 14:30:51
...
var CopyAnalyzer_1 = __importDefault(require("./CopyAnalyzer"));
var Crowller = /** @class */ (function () {
    function Crowller(url, copyAnalyzer) {
        this.url = url;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        html = _a.sent();
                        fileCount = this.copyAnalyzer.analyze(html, this.filePath);
